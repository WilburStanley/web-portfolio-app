    ...
    return (
        <section className={style.contactContainer} id="contact">
            ...
            <p className={style.description}>
                I’m {highlight('Wilbur Stanley Jimenez')}, founder of <strong>{highlight('BrightLabs University')}</strong>. 
            ...
            <div className={style.buttonGroup}>
                ...
                <a
                    href="https://brightlabs-official-website.vercel.app/#socials" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className={`${style.contactButton} ${style.secondaryButton}`} >
                    <Globe size={20} />
                    Visit BrightLabs University
                </a>
            </div>
        </section>
    );
